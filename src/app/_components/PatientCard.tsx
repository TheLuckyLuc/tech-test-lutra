...
const PatientCard = ({ firstName, lastName, isActive, patientId }: PatientCardProps) => {
  return (
    <div className='group relative rounded border border-gray-200 bg-white p-2'>
      ...
      <h3 className='mt-2 font-semibold'>
        <Link href={`/patient/${patientId}`} className='focus:outline-none group-hover:text-blue-600'>
